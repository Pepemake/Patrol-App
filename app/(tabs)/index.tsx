...
export default function SecurityPatrolScreen() {
  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderMove: (evt, gestureState) => {
        // moveY on sormen sijainti ruudulla. Vähennetään headerin osuus.
      ...
      onPanResponderRelease: () => {
        // Tähän voisi laittaa snappauksen, jos haluaa
      }
    })
  ).current;
  ...
  return (
    <View style={styles.container}>
      ...
      {/* RAPORTTILISTA JA KIERROSHALLINTA */}
